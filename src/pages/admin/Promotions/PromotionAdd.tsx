...
const PromotionAdd = () => {
    ...
    const items = ['Quản lý chương trình giảm giá', '/', 'Tạo giảm giá mới']
    ...
    const handleSubmit = (e: any) => {
        ...
        if (promotion.promotionName.trim() && promotion.discountPercent.toString().trim()) {
            ...
            axios.post('Promotion', updatedPromotion)
                .then(() => {
                    if (toast.current) {
                        toast.current.show({ 
                            severity: 'success', summary: 'Thành công', 
                            detail: 'Chương trình giảm giá đã được thêm', 
                            life: 2000 
                        });
                    }
                    setPromotion({ 
        ...
        <div className='main-content'>
            ...
            <form className="form">
                <div className="p-field">
                    ...
                    <InputText id="promotionName" name="promotionName" onChange={handleChange} 
                ...
                <Button className="p-button" label="Thêm loại sản phẩm" icon="pi pi-check" 
